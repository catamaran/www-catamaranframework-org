<nav id="site-navigation" class="main-navigation" role="navigation">
    ...
    <div class="menu-catamaran-menu-container">
        <ul id="menu-catamaran-menu" class="nav-menu">
            ...
            <li id="menu-item-33" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-33"><a href="https://github.com/catamaran/catamaran-framework/issues">Bugs</a></li>
            <li id="menu-item-34" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-34"><a href="https://docs.google.com/file/d/0B_4ijM9TbnLzSF93WEdmWnpBZzA/edit">Conventions</a></li>
            <li id="menu-item-35" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-35"><a href="http://scandilabs.com/contact">Contact</a></li>
        </ul>
    </div>     
</nav>